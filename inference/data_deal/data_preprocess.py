...
***注意：先修改stl路径， obj保存路径 和 下采样后obj存放路径***
"""

import sys
sys.path.append(r"/home/heygears/work/github/MeshCNN/hgapi")
import hgapi
import os
import glob
...
if __name__ == "__main__":
    ...
    if not os.path.isdir(down_obj_save_dir):
        os.makedirs(down_obj_save_dir)
    ...
    import bpy
    # # 下采样
    print('args: ', obj_save_dir, target_faces, down_obj_save_dir)
    blender = SampleProcess(obj_save_dir, target_faces, down_obj_save_dir)
